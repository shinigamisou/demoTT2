<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="w3c.home" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div class="header">
                <%--<div class="header-1">--%>
                <a class="header-btn">HOME</a>
                <a class="header-btn">BAND</a>
                <a class="header-btn">TOUR</a>
